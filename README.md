...
## 7.6 Linux (Splunk Server) Backup Strategy

Ubuntu server backups include:

- Splunk configuration directories
- Indexed data (as required)
...
- SIEM recovery
- Preservation of dashboards
- Log data retention

---

## 7.7 pfSense Configuration Backup

pfSense configuration exported regularly:
...
- Manual export
- Scheduled config backup (if enabled)

Purpose:

- Rapid firewall rebuild
- Protection against misconfiguration

---

## 7.8 3-2-1 Backup Rule Applied

The environment follows the industry-standard 3-2-1 rule:
...
|---------------|----------------------|-----------------|
| Active Directory | < 2 hours         | < 24 hours     |
| File Server   | < 4 hours            | < 24 hours     |
| Splunk SIEM   | < 6 hours            | < 24 hours     |
| pfSense       | < 1 hour             | Config-based   |

---

## 7.10 Disaster Recovery Scenarios

### Scenario 1 — Ransomware on File Server
- Restore files from clean backup
- Verify integrity
- Rejoin server to domain if required

### Scenario 2 — Domain Controller Failure
- Perform system state restore
- Rebuild DC if required
- Restore AD services

### Scenario 3 — Firewall Failure
- Reinstall pfSense
- Import saved configuration
- Restore network connectivity

### Scenario 4 — Splunk Server Failure
- Restore Splunk configs
- Rebuild indexes if needed
- Resume SIEM operations

---

## 7.11 Business Continuity Impact
...
- Compliance-style data protection
...
✅ File data protected  
✅ Network config recoverable  
✅ SIEM recoverable  
✅ Enterprise-grade DR mindset  

---

## Result

This backup and disaster recovery strategy ensures the SMB environment is resilient, secure, and operational even during major incidents.

It demonstrates real-world IT and cybersecurity operational maturity.

---

➡️ **Next Section (Optional):**  
Incident Response Playbooks & Tabletop Scenarios
```
